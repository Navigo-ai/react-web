...
import { PreconfiguredProducts, ProductResponse, ProductTemplate } from './models';
...
class GootenClient {
    ...
    {
        const response = await this.axios.post('preconfiguredproducts', product, this.params);
